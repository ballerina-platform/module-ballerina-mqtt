...
service on mqttSubscriber {
    ...
    remote function onError(mqtt:Error 'error) returns error|() {
    }
}
...
service on mqttSubscriber {
    ...
    remote function onError(mqtt:Error 'error) returns mqtt:Error|() {
    }
}
...
service on mqttSubscriber {
    ...
    remote function onError(mqtt:Error 'error) returns mqtt:Error|error? {
    }
}
