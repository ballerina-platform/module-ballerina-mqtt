...
service on mqttSubscriber {
    remote function onMessage(mqtt:Message message, string someval) {
    }
}

service on mqttSubscriber {
    remote function onMessage(mqtt:Message message, mqtt:Caller[] callers) {
    }
}

service on mqttSubscriber {
    remote function onMessage(mqtt:Message message, mqtt:Subscription subscription) {
    }
}
